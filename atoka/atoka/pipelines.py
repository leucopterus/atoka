...
class ExcelOutputPipeline:
    def __init__(self):
        self.wb_path = os.path.join(BASE_DIR, 'atoka/spiders/output/output14000-24000.xlsx')
        self.error_wb_path = os.path.join(BASE_DIR, 'atoka/spiders/output/error14000-24000.xlsx')
