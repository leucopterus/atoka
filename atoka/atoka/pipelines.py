...
class ExcelOutputPipeline:
    def __init__(self):
        self.wb_path = os.path.join(BASE_DIR, 'atoka/spiders/output/output24500-25000.xlsx')
        self.error_wb_path = os.path.join(BASE_DIR, 'atoka/spiders/output/error24500-25000.xlsx')
