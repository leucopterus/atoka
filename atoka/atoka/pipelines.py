...
class ExcelOutputPipeline:
    def __init__(self):
        self.wb_path = os.path.join(BASE_DIR, 'atoka/spiders/output/output25000-34500.xlsx')
        self.error_wb_path = os.path.join(BASE_DIR, 'atoka/spiders/output/error25000-34500.xlsx')
